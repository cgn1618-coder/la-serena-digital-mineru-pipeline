...
ZIPS_DIR = os.getenv("ZIPS_DIR", "/root/pipeline/mineru_output")
FIGURES_DIR = os.getenv("FIGURES_DIR", "/root/portal/static/figures")
EXTRACT_DIR = os.getenv("EXTRACT_DIR", "/tmp/mineru_ingest")
